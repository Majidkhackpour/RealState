    ...
    public partial class frmShowDocumentType : MetroForm
    {
        ...
        private async Task LoadDataAsync(string search = "")
        {
            try
            {
                ...
                var list = await DocumentTypeBussines.GetAllAsync(search, _token.Token);
        ...
        private async void frmShowDocumentType_Load(object sender, EventArgs e) => await LoadDataAsync();
