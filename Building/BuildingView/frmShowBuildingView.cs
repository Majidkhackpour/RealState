    ...
    public partial class frmShowBuildingView : MetroForm
    {
        ...
        private async Task LoadDataAsync(string search = "")
        {
            try
            {
                ...
                var list = await BuildingViewBussines.GetAllAsync(search, _token.Token);
        ...
        private async void frmShowBuildingView_Load(object sender, EventArgs e) => await LoadDataAsync();
