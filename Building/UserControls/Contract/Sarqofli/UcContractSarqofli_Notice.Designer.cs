...
{
    partial class UcContractSarqofli_Notice
    {
        /// <summary> 
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(UcContractSarqofli_Notice));
    ...
    "دارد.";
            ...
            this.label4.Text = "1- احراز رضایت مالک نسبت به انتقال حق سرقفلی الزامی است و رضایت مالک قبل یا همزما" +
    "ن با تنظیم این قرارداد باید اخذ شده باشد.";
            // 
            // grpPanel
            // 
            ...
            this.grpPanel.Size = new System.Drawing.Size(848, 260);
            // 
            // 
            // 
            ...
            this.label8.Text = "6- هرگونه توافق فی مابین طرفین قرارداد که در فوق ذکر نگردیده است، باید در قسمت تو" +
    "ضیحات یا در ظهر این قرارداد مکتوب شده و امضای طرفین و شهود و مشاور املاک برسد.";
            ...
            this.label3.Text = "5- نحوه استعلام کد رهگیری، ارسال کد ملی و کد رهگیری قراداد در قالب (کدملی طرف قرا" +
    ...
    "شد.";
            ...
            this.Name = "UcContractSarqofli_Notice";
