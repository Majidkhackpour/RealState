...
namespace Building.KitchenService
{
    public partial class frmShowKitchenService : MetroForm
    {
        ...
        private async Task LoadDataAsync(string search = "")
        {
            try
            {
                var list = await KitchenServiceBussines.GetAllAsync(search, _token.Token);
        ...
        private async void frmShowKitchenService_Load(object sender, EventArgs e) => await LoadDataAsync();
