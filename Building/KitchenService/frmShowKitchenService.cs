...
{
    public partial class frmShowKitchenService : MetroForm
    {
        ...
        private async Task LoadDataAsync(bool status, string search = "")
        {
            try
            {
                var list = await KitchenServiceBussines.GetAllAsync(search);
                Invoke(new MethodInvoker(() => KitchenBindingSource.DataSource =
        ...
        private void SetAccess()
        {
            try
            {
                ...
                mnuStatus.Enabled = access?.KitchenService.Kitchen_Service_Disable ?? false;
        ...
        private async void frmShowKitchenService_Load(object sender, EventArgs e)
        {
        ...
        private void frmShowKitchenService_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                switch (e.KeyCode)
        ...
        private async void mnuDelete_Click(object sender, EventArgs e)
        {
            ...
            finally
            {
                if (res.HasError)
                {
                    var frm = new FrmShowErrorMessage(res, "خطا در تغییر وضعیت سرویس آشپزخانه");
                    frm.ShowDialog(this);
                    frm.Dispose();
                }
