    ...
    public partial class frmShowBuildingOption : MetroForm
    {
        ...
        private void SetAccess()
        {
            try
            {
                ...
                mnuAdd.Enabled = access?.BuildingOption.Building_Option_Insert ?? false;
                ...
                mnuStatus.Enabled = access?.BuildingOption.Building_Option_Disable ?? false;
        ...
        private async void mnuDelete_Click(object sender, EventArgs e)
        {
            ...
            finally
            {
                if (res.HasError)
                {
                    var frm = new FrmShowErrorMessage(res, "خطا در تغییر وضعیت امکانات ملک");
                    frm.ShowDialog(this);
                    frm.Dispose();
                }
