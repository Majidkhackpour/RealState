...
namespace WebHesabBussines
{
    public class WebPeopleGroup : IPeopleGroup
    {
        ...
        private async Task SendAsync()
        {
            try
            {
                var res = await Extentions.PostToApi<WebPeopleGroup, WebPeopleGroup>(this, Url, WebCustomer.Customer.Guid);
        ...
        public static async Task<ReturnedSaveFuncInfo> SendAsync(WebPeopleGroup cls)
        {
        ...
        public static async Task<ReturnedSaveFuncInfo> SendAsync(List<WebPeopleGroup> cls)
        {
            var res = new ReturnedSaveFuncInfo();
            try
            {
