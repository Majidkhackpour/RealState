...
namespace WebHesabBussines
{
    public class WebCity : ICities
    {
        ...
        private async Task SendAsync()
        {
            try
            {
                var res = await Extentions.PostToApi<WebCity, WebCity>(this, Url, WebCustomer.Customer.Guid);
        ...
        public static async Task<ReturnedSaveFuncInfo> SendAsync(WebCity cls)
        {
        ...
        public static async Task<ReturnedSaveFuncInfo> SendAsync(List<WebCity> cls)
        {
            var res = new ReturnedSaveFuncInfo();
            try
            {
