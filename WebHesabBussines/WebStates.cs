...
namespace WebHesabBussines
{
    public class WebStates : IStates
    {
        ...
        private async Task SendAsync()
        {
            try
            {
                var res = await Extentions.PostToApi<WebStates, WebStates>(this, Url, WebCustomer.Customer.Guid);
        ...
        public static async Task<ReturnedSaveFuncInfo> SendAsync(WebStates cls)
        {
        ...
        public static async Task<ReturnedSaveFuncInfo> SendAsync(List<WebStates> cls)
        {
            var res = new ReturnedSaveFuncInfo();
            try
            {
