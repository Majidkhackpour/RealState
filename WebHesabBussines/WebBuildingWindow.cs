...
{
    public class WebBuildingWindow : IBuildingWindow
    {
        private static string Url = Utilities.WebApi + "/api/BuildingWindow/SaveAsync";
        ...
        public static async Task<ReturnedSaveFuncInfo> SendAsync(WebBuildingWindow cls)
        {
        ...
        public static async Task<ReturnedSaveFuncInfo> SendAsync(List<WebBuildingWindow> cls)
        {
            var res = new ReturnedSaveFuncInfo();
            try
            {
