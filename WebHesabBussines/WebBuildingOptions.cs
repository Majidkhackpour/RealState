...
namespace WebHesabBussines
{
    public class WebBuildingOptions : IBuildingOptions
    {
        ...
        public static async Task<ReturnedSaveFuncInfo> SaveAsync(WebBuildingOptions cls)
        {
        ...
        public static async Task<ReturnedSaveFuncInfo> SaveAsync(List<WebBuildingOptions> cls)
        {
            var res = new ReturnedSaveFuncInfo();
            try
            {
