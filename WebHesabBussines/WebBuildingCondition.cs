...
namespace WebHesabBussines
{
    public class WebBuildingCondition : IBuildingCondition
    {
        ...
        private async Task SendAsync()
        {
            try
            {
                var res = await Extentions.PostToApi<WebBuildingCondition, WebBuildingCondition>(this, Url, WebCustomer.Customer.Guid);
        ...
        public static async Task<ReturnedSaveFuncInfo> SendAsync(WebBuildingCondition cls)
        {
        ...
        public static async Task<ReturnedSaveFuncInfo> SendAsync(List<WebBuildingCondition> cls)
        {
            var res = new ReturnedSaveFuncInfo();
            try
            {
