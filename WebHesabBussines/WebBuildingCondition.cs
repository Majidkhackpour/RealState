...
namespace WebHesabBussines
{
    public class WebBuildingCondition : IBuildingCondition
    {
        ...
        public async Task SaveAsync()
        {
            try
            {
                var res = await Extentions.PostToApi<WebBuildingCondition, WebBuildingCondition>(this, Url);
        ...
        public static async Task<ReturnedSaveFuncInfo> SaveAsync(WebBuildingCondition cls)
        {
        ...
        public static async Task<ReturnedSaveFuncInfo> SaveAsync(List<WebBuildingCondition> cls)
        {
            var res = new ReturnedSaveFuncInfo();
            try
            {
