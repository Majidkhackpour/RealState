...
namespace WebHesabBussines
{
    public class WebRental : IRentalAuthority
    {
        ...
        private async Task SendAsync()
        {
            try
            {
                var res = await Extentions.PostToApi<WebRental, WebRental>(this, Url, WebCustomer.Customer.Guid);
        ...
        public static async Task<ReturnedSaveFuncInfo> SendAsync(WebRental cls)
        {
        ...
        public static async Task<ReturnedSaveFuncInfo> SendAsync(List<WebRental> cls)
        {
            var res = new ReturnedSaveFuncInfo();
            try
            {
