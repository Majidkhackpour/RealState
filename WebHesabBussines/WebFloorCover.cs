...
namespace WebHesabBussines
{
    public class WebFloorCover : IFloorCover
    {
        ...
        private async Task SendAsync()
        {
            try
            {
                var res = await Extentions.PostToApi<WebFloorCover, WebFloorCover>(this, Url, WebCustomer.Customer.Guid);
        ...
        public static async Task<ReturnedSaveFuncInfo> SendAsync(WebFloorCover cls)
        {
        ...
        public static async Task<ReturnedSaveFuncInfo> SendAsync(List<WebFloorCover> cls)
        {
            var res = new ReturnedSaveFuncInfo();
            try
            {
