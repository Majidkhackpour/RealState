...
namespace WebHesabBussines
{
    public class WebDocumentType : IDocumentType
    {
        ...
        private async Task SendAsync()
        {
            try
            {
                var res = await Extentions.PostToApi<WebDocumentType, WebDocumentType>(this, Url, WebCustomer.Customer.Guid);
        ...
        public static async Task<ReturnedSaveFuncInfo> SendAsync(WebDocumentType cls)
        {
        ...
        public static async Task<ReturnedSaveFuncInfo> SendAsync(List<WebDocumentType> cls)
        {
            var res = new ReturnedSaveFuncInfo();
            try
            {
