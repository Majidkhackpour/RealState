...
namespace WebHesabBussines
{
    public class WebDocumentType : IDocumentType
    {
        ...
        public static async Task<ReturnedSaveFuncInfo> SaveAsync(WebDocumentType cls)
        {
        ...
        public static async Task<ReturnedSaveFuncInfo> SaveAsync(List<WebDocumentType> cls)
        {
            var res = new ReturnedSaveFuncInfo();
            try
            {
