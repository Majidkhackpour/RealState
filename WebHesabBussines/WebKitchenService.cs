...
{
    public class WebKitchenService : IKitchenService
    {
        private static string Url = Utilities.WebApi + "/api/KitchenService/SaveAsync";
        ...
        private async Task SendAsync()
        {
            try
            {
                var res = await Extentions.PostToApi<WebKitchenService, WebKitchenService>(this, Url, WebCustomer.Customer.Guid);
        ...
        public static async Task<ReturnedSaveFuncInfo> SendAsync(WebKitchenService cls)
        {
        ...
        public static async Task<ReturnedSaveFuncInfo> SendAsync(List<WebKitchenService> cls)
        {
            var res = new ReturnedSaveFuncInfo();
            try
            {
