...
namespace WebHesabBussines
{
    public class WebBuildingType : IBuildingType
    {
        ...
        public async Task SaveAsync()
        {
            try
            {
                var res = await Extentions.PostToApi<WebBuildingType, WebBuildingType>(this, Url);
        ...
        public static async Task<ReturnedSaveFuncInfo> SaveAsync(WebBuildingType cls)
        {
        ...
        public static async Task<ReturnedSaveFuncInfo> SaveAsync(List<WebBuildingType> cls)
        {
            var res = new ReturnedSaveFuncInfo();
            try
            {
