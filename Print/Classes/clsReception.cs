        ...
        public class One
        {
            public static Stimulsoft.Report.StiReport GetSti(Stimulsoft.Report.StiReport sti, EnPrintType peper)
            {
                try
                {
                    ...
                    switch (peper)
                    {
                        case EnPrintType.A4: return Reception_One_A4(sti);
                        case EnPrintType.A5: return Reception_One_A5(sti);
                    }
                }
                catch (Exception ex)
                {
        ...
        public class List
        {
            public static Stimulsoft.Report.StiReport GetSti(Stimulsoft.Report.StiReport sti, EnPrintType peper)
            {
                try
                {
                    ...
                    switch (peper)
                    {
                        case EnPrintType.A4: return Reception_List_A4(sti);
                        case EnPrintType.A5: return Reception_List_A5(sti);
                    }
                }
                catch (Exception ex)
                {
