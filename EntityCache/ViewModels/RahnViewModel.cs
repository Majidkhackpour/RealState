namespace EntityCache.ViewModels
{
    public class RahnViewModel
    {
        ...
        public string ContractfDate { get; set; }
        public string ContractsDate { get; set; }
        public string UnitAddress { get; set; }
        public decimal TotalEjare { get; set; }
        public decimal MinorEjare { get; set; }
        public decimal Rahn { get; set; }
