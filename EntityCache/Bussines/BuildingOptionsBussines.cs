    ...
    public class BuildingOptionsBussines : IBuildingOptions
    {
            ...
            string tranName = "")
        {
            ...
            try
            {
                ...
                res.AddReturnedValue(await UnitOfWork.BuildingOption.SaveRangeAsync(list, tranName));
        ...
        public async Task<ReturnedSaveFuncInfo> ChangeStatusAsync(bool status, string tranName = "")
        {
            ...
            try
            {
                ...
                res.AddReturnedValue(await UnitOfWork.BuildingOption.ChangeStatusAsync(this, status, tranName));
                res.ThrowExceptionIfError();
                if (autoTran)
                {
                    //CommitTransAction
        ...
        public static List<BuildingOptionsBussines> GetAll(string search) => AsyncContext.Run(() => GetAllAsync(search));
