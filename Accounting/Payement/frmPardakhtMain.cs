    ...
    public partial class frmPardakhtMain : MetroForm
    {
        ...
        private void SetReceptor()
        {
            try
            {
                ...
                {
                    var hesab = HazineBussines.Get(_receptorGuid);
                    if (hesab == null) return;
                    txtName.Text = hesab.Name;
                }
            }
        ...
        public frmPardakhtMain(Guid receptorGuid, EnAccountingType _type)
        {
            InitializeComponent();
        ...
        #region TxtSetter
        private async void frmPardakhtMain_Load(object sender, EventArgs e)
        {
            SetData();
            var myCollection = new AutoCompleteStringCollection();
            var list = await PardakhtBussines.GetAllAsync();
