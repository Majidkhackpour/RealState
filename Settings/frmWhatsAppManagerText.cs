...
namespace Settings
{
    public partial class frmWhatsAppManagerText : MetroForm
    {
        ...
        public frmWhatsAppManagerText() => InitializeComponent();
        ...
        private void btnOwnerName_Click(object sender, System.EventArgs e) => SetDataInTxt((ButtonX)sender, txtText);
